...
export default class Constructors {
	...
	* @param { (number | string | BN) } initCount,
	* @param { string } initText,
	*/
   	async "new" (
   		initValue: boolean,
   		initCount: (number | string | BN),
   		initText: string,
        ...
        const tx = code.tx["new"]!({ gasLimit, storageDepositLimit, value: __options?.value }, initValue, initCount, initText);
		let response;
